...
I picked a variable described as "`r df$IndicatorName[1]`"
...
I now have a smaller data frame with variable names that I like.
...
p<- leaflet(shape, options= leafletOptions( minZoom=6, maxZoom=12) )%>% 
...
```{r, echo=TRUE,  width = 30, height = 20}
p
```
