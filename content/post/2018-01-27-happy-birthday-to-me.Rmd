...
```
As you can the most common word is just the letter a with a hat. Since it is a not a real word I am going to remove it. 
```{r}
...
Unfortunately it looks like most of the words used in the titles on my birthday over the years have been negative. I am not going to let that stop me from having a good time today. 
